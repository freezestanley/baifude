...
export default {
  ...
  data() {
    return {
      ...
      navDescriptionMap: new Map([["Packages","定期送福利"],["Movies","大片及时看"],["Shows","精彩在现场"],["Travel","一起再出发"],["Birthday","精选温情礼"],['Shopping','好物随心购'],['Health','全民享健康'],['Jingdong','百货云集馆']]),
    };
  },
  computed: {
    ...mapState({
...
.nav {
  ...
  .twoItem{
    ...
    .towNavWrap{
      ...
      &.JingdongBg{
        background-image: url("../../../../../assets/images/fashion/fashion_card_jingdong_eng.png");
      }
